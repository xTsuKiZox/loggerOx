...
const serverConfig = require('./configLoggerOx.json');
 ...
 * @param {string} lang Language chosen by the person | fr/en
*/
async function getBanAdd(client, lang) {
    try {
 ...
 * @param {string} lang Language chosen by the person | fr/en
*/
async function getBanRemove(client, lang) {
    try {
 ...
 * @param {string} lang Language chosen by the person | fr/en
*/
async function getScheduledCreate(client, lang) {
    try {
 ...
 * @param {string} lang Language chosen by the person | fr/en
*/
async function getGuildMemberUpdate(client, lang) {
    try {
